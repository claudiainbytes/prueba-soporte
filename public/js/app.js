...
var render = function render() {
  ...
  return _c("div", {
    ...
    return _c("li", {
      ...
      staticClass: "mb-1"
    }, [_vm._v(_vm._s(task.description) + ", Completed: " + _vm._s(task.completed))]), _vm._v(" "), _c("small", {
      staticClass: "text-muted"
    }, [_vm._v("Assigned to: " + _vm._s(task.user.name) + " " + _vm._s(task.user.email))])]), _vm._v(" "), _c("div", [_c("button", {
      staticClass: "btn btn-success btn-sm mr-2",
      on: {
        click: function click($event) {
          return _vm.completeTask(task.id, task);
        }
      }
    ...
    staticClass: "form-control",
    attrs: {
      placeholder: "Assigned User E-mail",
      required: ""
    },
    domProps: {
      value: _vm.newTask.email
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  actions: {
    ...
    completeTask: function completeTask(_ref2, taskId) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].put("/tasks/".concat(taskId)).then(function (response) {
    ...
    fetchTasks: function fetchTasks(_ref4) {
      ...
      axios__WEBPACK_IMPORTED_MODULE_2__["default"].get('/tasks').then(function (response) {
